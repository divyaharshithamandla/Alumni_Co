   ...
   const [age,setAge]=useState([]);
    ...
    return(
      ...
      <div className="form-group">   
        ...
        <div className="form-group">
        <label> <b>Last Name </b><input type="text" placeholder="enter Second name" onChange={(e)=>setLname(e.target.value)}></input></label></div>
        <div className="form-group">
        ...
        <div className="i1">
        <input type="file" onChange={handleFileChange}> image-upload</input></div></div>
        <br/>
...
export default Aluminiprofile2;